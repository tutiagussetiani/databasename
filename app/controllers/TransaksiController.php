...
class TransaksiController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				transaksi.id_user LIKE ? OR 
				transaksi.id_buku LIKE ? OR 
				transaksi.tgl_pinjam LIKE ? OR 
				transaksi.tgl_kembali LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id_user","id_buku","tgl_pinjam","tgl_kembali","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","id_user","id_buku","tgl_pinjam","tgl_kembali","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'id_user' => 'required|numeric',
