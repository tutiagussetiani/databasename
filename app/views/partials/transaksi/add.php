                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_user"  value="<?php  echo $this->set_field_value('id_user',""); ?>" type="number" placeholder="Enter Id User" step="1"  required="" name="id_user"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_buku"  value="<?php  echo $this->set_field_value('id_buku',""); ?>" type="number" placeholder="Enter Id Buku" step="1"  required="" name="id_buku"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="tgl_pinjam">Tgl Pinjam <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-tgl_pinjam"  value="<?php  echo $this->set_field_value('tgl_pinjam',""); ?>" type="text" placeholder="Enter Tgl Pinjam"  required="" name="tgl_pinjam"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-tgl_kembali"  value="<?php  echo $this->set_field_value('tgl_kembali',""); ?>" type="text" placeholder="Enter Tgl Kembali"  required="" name="tgl_kembali"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
